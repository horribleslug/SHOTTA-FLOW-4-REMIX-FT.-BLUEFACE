...
PATH = "/home/nicholas/SHOTTA-FLOW-4-REMIX-FT.-BLUEFACE/src/training/pictures/numbers"
...
for filename in glob.glob(PATH + '/spots/*.png'):
    platehsv = cv2.imread(filename)
    platehsv = cv2.cvtColor(platehsv, cv2.COLOR_BGR2GRAY)
    '''
    ...
    '''
    chars.append(platehsv)
    output.extend([hotlocalsingles(filename[-10])])
